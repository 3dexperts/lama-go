...
export class BoardDecoder {
    ...
    */
    static new(board_edge_size) {
        const ret = wasm.boarddecoder_new(board_edge_size);
        return BoardDecoder.__wrap(ret);
    }
    /**
    */
    clear() {
        wasm.boarddecoder_clear(this.__wbg_ptr);
    }
    /**
    ...
    */
    get_board() {
        ...
        try {
            ...
            wasm.boarddecoder_get_board(retptr, this.__wbg_ptr);
...
export class BoardEncoder {
    ...
    */
    clear() {
        wasm.boardencoder_clear(this.__wbg_ptr);
    }
    /**
    ...
    */
    get_encoded_string() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.boardencoder_get_encoded_string(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
